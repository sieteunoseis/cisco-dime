...
if (process.env.NODE_OPTIONS){
  console.log("cisco-dime: Enabling experimental vm modules. Needed for Fetch API");
}

if(process.env.NODE_NO_WARNINGS){
  console.log("cisco-dime: Disabling warnings");
}

if(process.env.NODE_TLS_REJECT_UNAUTHORIZED){
  console.log(
    "cisco-dime: Disabling certificate validation for TLS connections. This makes TLS, and HTTPS by extension, insecure. The use of this environment variable is strongly discouraged"
  );
}else{
  console.log(
    "cisco-dime: Self-signed certificates may cause issues"
  );
}
